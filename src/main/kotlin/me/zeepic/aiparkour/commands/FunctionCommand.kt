...
class FunctionCommand(name: String, val function: KCommand, private val parsers: Map<KParameter, ArgumentParser<*>>, permission: String = "", description: String = "", usage: String = "", aliases: List<String> = listOf()) : BukkitCommand(name, description, usage, aliases) {
    ...
    override fun execute(sender: CommandSender, commandLabel: String, args: Array<out String>?): Boolean {
        ...
        val successes = parsers.mapKeys { (parameter, parser) ->
